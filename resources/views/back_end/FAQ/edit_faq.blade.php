           ...
           <div class="card">
             ...
             <div class="card-body">
               <div class="tab-content">
                ...
                <form method="POST" action="{{ route('faq.update',$alldata->id) }}" enctype="multipart/form-data" id="myForm">
                 @csrf
                ...
                <div class="row">
                 ...
                 <div class="col-md-12 mt-2">
                  ...
                  <input type="text" name="question" value="{{ $alldata->question }}" class="form-control form-control-sm" placeholder="FAQ Question">
                 </div>

                 <div class="col-md-12 mt-2">
                  <smail for="anwser">Answer</smail>
                  <textarea name="anwser" class="form-control form-control-sm" id="" rows="7">
                    {!! $alldata->anwser !!}
                  </textarea>
                 </div>
