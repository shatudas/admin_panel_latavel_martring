           ...
           <div class="card">
             ...
             <div class="card-body">
               <div class="tab-content">
                ...
                <form method="POST" action="{{ route('photo.store') }}" enctype="multipart/form-data" id="myForm">
                 @csrf
                ...
                <div class="row">
                 ...
                 <div class="col-md-6 mt-2">
                  ...
                  <input type="text" name="content" class="form-control form-control-sm" placeholder="Content">
                 </div>
                 ...
                 <div class="form-group col-md-6 mt-3">
                  <img id="showImage" src="{{url('upload/no_image.png')}}" style="width:80%; height:140px; border:1px solid #CCC; ">
                 </div>
