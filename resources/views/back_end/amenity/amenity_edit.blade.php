           ...
           <div class="card">
             ...
             <div class="card-body">
               <div class="tab-content">
                ...
                <form method="POST" action="{{ route('amenity.update',$alldata->id) }}" enctype="multipart/form-data" id="myForm">
                 @csrf
                ...
                <div class="row">
                 ...
                 <div class="col-md-12 mt-2">
                  ...
                  <input type="text" name="name" value="{{ $alldata->name }}" class="form-control form-control-sm" placeholder="Name">
                 </div>
