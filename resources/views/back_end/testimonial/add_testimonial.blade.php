           ...
           <div class="card">
             ...
             <div class="card-body">
               <div class="tab-content">
                ...
                <form method="POST" action="{{ route('testimonial.store') }}" enctype="multipart/form-data" id="myForm">
                 @csrf
                ...
                <div class="row">
                 ...
                 <div class="col-md-12 mt-2">
                  ...
                  <textarea type="text" name="massage" rows="5" class="form-control form-control-sm"></textarea>
                 ...
                 <div class="form-group col-md-6">
                  <img id="showImage" src="{{url('upload/no_image.png')}}" style="width:100px; height:100px; border:1px solid #CCC;">
                 </div>
