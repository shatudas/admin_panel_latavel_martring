           ...
           <div class="card">
             ...
             <div class="card-body">
               <div class="tab-content">
                ...
                <form method="POST" action="{{ route('feature.update',$alldata->id) }}" enctype="multipart/form-data" id="myForm">
                 @csrf
                ...
                <div class="col-md-12 mt-2">
                  ...
                  <input type="text" name="icon" class="form-control form-control-sm" value="{{ $alldata->icon }}" placeholder="fa fa icon">
                  <font style="color:red">{{($errors->has('icon'))?($errors->first('icon')):'' }}</font>
                </div>

                 <div class="col-md-12 mt-2">
                  <smail for="heading">Heading</smail>
                  <input type="text" name="heading" class="form-control form-control-sm" value="{{ $alldata->heading }}"  placeholder="heading">
                  <font style="color:red">{{($errors->has('heading'))?($errors->first('heading')):'' }}</font>
                 </div>

                 <div class="col-md-12 mt-2">
                  <smail for="detalis">Detalis</smail>
                  <textarea name="detalis" id="" rows="3" style="width:100%;" class="form-control form-control-sm">{!! $alldata->detalis !!}</textarea>
                 </div>
