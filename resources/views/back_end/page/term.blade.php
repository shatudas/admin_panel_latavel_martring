         ...
         <div class="col-md-9">
           <div class="card">
             ...
             <div class="card-header">
              <h3 class="card-title">Update Terms & Condition</h3>
             </div>

             <div class="card-body">
               <div class="tab-content">

                <form method="POST" action="{{ route('terms.update',$alldata->id) }}" enctype="multipart/form-data" id="myForm">
                 @csrf
                ...
                <div class="row">
                 ...
                 <div class="col-md-12 mt-2">
                  ...
                  <textarea name="detalis" id="summernote" class="form-control form-control-sm" id="" rows="7">
                    {!! $alldata->detalis !!}
                  </textarea>
                 </div>
